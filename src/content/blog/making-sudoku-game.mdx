...
And this week, I'll walk you through how I built a simple Sudoku game combining all of the algorithms and 
...
<Image
  src={sudokuGameScreenshot}
  alt="Sudoku game screenshot"
/>

The first time when you open the game, Sudoku puzzle is generated and stored into a local storage. And every time when you come back,
...
new puzzle - and this time I implemented proper generation, let me walk you out how it's done.
...
This code is almost the same as the code that we wrote next week to solve a Sudoku. Biggest difference is that
...
there is no need to know *exactly* how many solutions there are - it is enough to know that there is more than one.
...
that linked list - data structure often criticized for it's inefficiency - is perfect for this task! Let's take a look at how
...
every step was an opportunity to learn. I hope this inspires you to build something playful with algorithms too! 🎮
