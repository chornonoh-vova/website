...
<Image src={mainPage} alt="Screenshot of main page of example 'Track Manager' application." />
...
<Image src={modalError} alt="Screenshot of create track modal with errors on the fields" />
