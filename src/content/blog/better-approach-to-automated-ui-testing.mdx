...
Recently, I’ve stumbled upon a challenge in my day-to-day work as a frontend developer: it’s constantly changing UI. How is the one supposed to maintain the high quality of the code in such rapidly changing conditions? The answer is simple - automated tests.
