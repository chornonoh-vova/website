...
In this playground, you can select a fill color, click on a pixel, and observe in real-time how DFS performs a flood fill! You can also reset the image back to it's initial state by pressing the "Reset" button.
...
In this playground, you can select a fill color, click on a pixel, and observe in real-time how BFS performs a flood fill, and compare it with DFS that you saw previously. You can also reset the image back to it's initial state by pressing the "Reset" button, just as in example from before.
