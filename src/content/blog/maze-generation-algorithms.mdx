...
Turns out, it's kind of a rabbit hole, with multiple approaches to solving
...
Here's an example of matrix with 5 rows and 7 columns, which shows, why width and height
...
The `createMazeInitial` is just creating a matrix with a given width and height, and
...
<MazeVisualization initialAlgo="randomized-dfs" client:visible />
...
<MazeVisualization initialAlgo="randomized-kruskals" client:visible />
...
<MazeVisualization initialAlgo="wilsons" client:visible />
