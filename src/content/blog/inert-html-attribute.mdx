...
import { RandomEmojiiSpawner } from "../../components/RandomEmojiiSpawner";
...
The additional interesting this about this property is that you can set it to all,
...
<RandomEmojiiSpawner client:load />

Just press a button, and random emojiis will get added onto the page! But you
