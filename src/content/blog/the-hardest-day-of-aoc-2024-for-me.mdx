...
{/* TODO: add graph with hover, highlighting 3-cliques */}

You can hover over the graph vertices to see the other two interconnected computers.
...
{/* TODO: Add graph with hover - highlighting maximum cliques */}

Now, when you hover over the vertex in a graph, the maximum clique that contains this vertex will be highlighted.
